                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={6}>
                        <FormControl component="fieldset" className={classes.formControl}>
                            <FormLabel component="legend">Types of house</FormLabel>
                            <RadioGroup aria-label="housetype" name="housetype" value={this.state.adsDetails.housetype} onChange={this.handleChange('housetype')}>
                                <FormControlLabel value="Apartment" control={<Radio color="primary" />} label="Apartment" />
                                <FormControlLabel value="Bungalow" control={<Radio color="primary" />} label="Bungalow" />
                            </RadioGroup>
                        </FormControl>
                    </Grid>
                    <Grid item xs={12}>
                    ...
                    <Grid item xs={12}>
                        <Button variant="outlined" className={classes.button} onClick={this.updateState}>
                            Save
                    </Button>
                    </Grid>
                </Grid>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(useStyles)(CreateAdds))